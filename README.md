...
### Συμπεράσματα
  ...
  Ολοκληρώνοντας, την εργασία συμπεραίνω πως η ανάπτυξη ενός ηλεκτρονικού παιχνιδιού είναι μια συναρπαστική εμπειρία. Αρχικά, μου δόθηκε η ευκαιρία να μάθω τη γλώσσα προγραμματισμού javascript μαζί με το game-engine Phaser. Στη συνέχεια, με έκανε να αναρωτηθώ και για έννοιες όπως αλληλεπίδραση ανθρώπου υπολογιστή για τη βελτίωση εμπειρίας του χρήστη στο παιχνίδι και εισαγωγή πολυμεσικού περιεχομένου σε αυτό, για τη σωστή παρουσίαση της πληροφορίας σε αυτόν.
